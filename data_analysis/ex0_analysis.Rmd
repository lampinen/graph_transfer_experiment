...
lookup_graph_name = function(subject_id, graph_trial_type) {
  ...
  condition = case_when(subject_id == "9" ~ "d",
                        subject_id == "34" ~ "b",
                        subject_id == "22" ~ "c",
                        subject_id == "25" ~ "d",
                        T ~ "NA")
...
ggplot(df_subj_corr_diffs,
       aes(x=graph_name, y=corr_diff, fill=graph_trial_type)) +
  geom_bar(stat="summary",
           fun.y="mean",
           position="dodge") +
  geom_errorbar(stat="summary",
...
ggsave("results/plots/basic_learning_effect_corr.png", width=4, height=6)
```
